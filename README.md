...
## Visual tests changed the theory

The tool stack only became meaningful when tested against different asset types.

A food image punished fake texture immediately. If an enhancer invented detail, berries became wrong, jam became wrong, and fried dough started looking like an engraved object.

A low-light garden image required the opposite logic: preserve darkness, reduce noise, guide the eye, and avoid over-recovering shadows into fake HDR.

An abstract watercolor/ink image tolerated more interpretive upscale because invented microstructure could read as pigment, paper tooth, or brush energy rather than material failure.

That became one of the strongest lessons of the project: there is no universal "enhance" button. Asset type determines tool risk.

### Visual example A - Syrniki Hearts

**Placement:** material truth / AI failure-mode section.

**Image placeholder:** `images/syrniki_hearts_final.jpg`

**Label:** Tier B - AI-assisted editorial food/lifestyle derivative.

**Caption:** Food image test: editorial mood enhancement worked only when material truth survived. Jam had to remain jam, berries had to remain berries, and syrniki had to remain food rather than AI-textured objects.

### Visual example B - Laundry

**Placement:** photographic derivative / mood and material routing section.

**Image placeholder:** `images/laundry_final.jpg`

**Label:** Tier B - AI-assisted photographic derivative.

**Caption:** Laundry image test: a weak everyday phone image became a usable cinematic derivative through atmosphere, composition, and material routing.

### Visual example C - Magic Garden

**Placement:** low-light rescue / mood lane section.

**Image placeholder:** `images/magic_garden_final.jpg`

**Label:** Mood / atmosphere candidate.

**Caption:** Low-light rescue test: the goal was not to recover every shadow, but to preserve the tunnel composition and make darkness intentional.

### Visual example D - Watercolor Palette

**Placement:** upscale / large-format print potential section.

**Image placeholder:** `images/watercolor_palette_final.jpg`

**Label:** Fine-art print / upscale candidate.

**Caption:** Abstract artwork test: abstraction tolerated upscale interpretation better than food or strict photography. This became the strongest candidate for a large-format upscale demonstration.

## The tool is not the system

The important skill was not knowing tool names.

It was knowing when not to use them.

Topaz, Upscayl, Lightroom, Photoshop, OpenAI image tools, CLIP, SigLIP2, OpenCV, and Python scripts all have a role. But the role changes by asset.

For food, aggressive texture recovery can destroy material truth.

For low-light mood images, over-brightening can destroy atmosphere.

For abstract artwork, upscale interpretation can become useful if it preserves gesture and avoids fake digital texture.

The tool is not the system.

The decision logic is the system.
